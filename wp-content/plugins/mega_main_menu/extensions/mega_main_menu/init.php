 ...
 */
	if ( is_admin() ) {
		...
		if ( ( is_array( $mega_menu_locations ) && ( in_array( $self_current_menu_location, $mega_menu_locations ) || in_array( 'mega_main_sidebar_menu', $mega_menu_locations ) ) ) || ( is_array( $mega_main_menu->get_option( 'indefinite_location_mode' ) ) && in_array( 'true', $mega_main_menu->get_option( 'indefinite_location_mode' ) ) ) ) {
