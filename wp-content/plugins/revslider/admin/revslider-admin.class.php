	...
	public static function enqueue_all_admin_scripts() {
		...
		foreach($post_types as $post_type) {
			if($post_type == $screen->id){
				wp_enqueue_script('revslider-tinymce-shortcode-script', plugins_url('assets/js/tinymce-shortcode-script.js', __FILE__ ), array('jquery'), RevSliderGlobals::SLIDER_REVISION );
			}
		}
	}
