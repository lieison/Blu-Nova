...
<div id="rs-validation-wrapper" style="display:<?php echo $displ; ?>">
	...
	<div class="validation-label"><?php _e('Username:','revslider'); ?></div> 
	<div class="validation-input"> 
		<input type="text" name="rs-validation-username" <?php echo ($validated === 'true') ? ' readonly="readonly"' : ''; ?> value="<?php echo $username; ?>" />
		<p class="validation-description"><?php _e('Your Envato username.','revslider'); ?></p>
	</div>
	<div class="clear"></div>
	
	<div class="validation-label"><?php _e('Envato API Key:','revslider'); ?> </div> 
	<div class="validation-input">
		<input type="password" name="rs-validation-api-key" value="<?php echo $api_key; ?>" <?php echo ($validated === 'true') ? ' readonly="readonly"' : ''; ?> style="width: 350px;" />
		<p class="validation-description"><?php _e('You can find the API key by visiting your Envato Account page, then clicking the My Settings tab. At the bottom of the page you will find your accounts API key.','revslider'); ?></p>
	</div>
	<div class="clear"></div>
