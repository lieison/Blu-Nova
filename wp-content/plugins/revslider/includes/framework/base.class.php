	...
	*/
	public static function get_all_image_sizes($type = 'gallery'){
		...
		switch($type){
			...
			case 'facebook':
				$custom_sizes = array(
					'size-0' => __('Size 0', 'revslider'),
					'size-1' => __('Size 1', 'revslider'),
					'size-2' => __('Size 2', 'revslider'),
					'size-3' => __('Size 3', 'revslider'),
					'size-4' => __('Size 4', 'revslider'),
					'size-5' => __('Size 5', 'revslider'),
					'size-6' => __('Size 6', 'revslider')
				);
			break;
			case 'youtube':
				$custom_sizes = array(
