...
if (!class_exists('Road_Theme_Config')) {
    ...
    class Road_Theme_Config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'        => 'image_404',
                        'type'      => 'media',
                        'title'     => __('Image 404', 'redux-framework'),
                        'compiler'  => 'true',
                        'mode'      => false,
                        'desc'      => __('Upload image here.', 'redux-framework'),
                    ),
                ),
            );
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        ...
                        'subtitle'  => __('Pick a color for primary color (default: #68c5ec).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#68c5ec',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for bg sale label (default: #0a0a0a).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#0a0a0a',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for sale label text (default: #fff).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#fff',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for star of rating (default: #666).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#666',
                        'validate'  => 'color',
                    ),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						...
						'type'     => 'select',
						'data'     => 'menus',
						'title'    => __( 'Top Menu', 'redux-framework' ),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						...
						'subtitle'         => __('HTML tags allowed: a, br, em, strong, span', 'redux-framework'),
						'default'          => 'Copyright © 2015 <a href="http://www.roadthemes.com/">Roadthemes.</a> All Rights Reserved',
						'args'   => array(
							'teeny'            => true,
							'textarea_rows'    => 5,
							'media_buttons'	=> false,
			...
			//Brand logos
			$this->sections[] = array(
                'title'     => __('Brand Logos', 'redux-framework'),
                'desc'      => __('Upload brand logos and links', 'redux-framework'),
                ...
                'fields'    => array(
					...
					array(
						'id'        => 'brandnumber',
						'type'      => 'slider',
						'title'     => __('Number of logo columns per page', 'redux-framework'),
						'desc'      => __('Number of logos columns per page, default value: 6', 'redux-framework'),
						"default"   => 4,
						"min"       => 1,
						"step"      => 1,
						"max"       => 12,
					...
					array(
						...
						'type'      => 'slider',
						'title'     => __('Scroll amount', 'redux-framework'),
						'desc'      => __('Number of logos to scroll one time, default value: 2', 'redux-framework'),
						"default"   => 2,
						"min"       => 1,
						"step"      => 1,
						"max"       => 12,
					...
					array(
						'id'          => 'brand_logos',
						'type'        => 'slides',
						'title'       => __('Logos', 'redux-framework'),
						'desc'        => __('Upload logo image and enter logo link.', 'redux-framework'),
						'placeholder' => array(
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						'id'=>'share_head_code',
						'type' => 'textarea',
						'title' => __('ShareThis/AddThis head tag', 'redux-framework'), 
						'desc' => __('Paste your ShareThis or AddThis head tag here', 'redux-framework-demo'),
						'default' => '',
					),
					array(
						'id'=>'share_code',
						'type' => 'textarea',
						'title' => __('ShareThis/AddThis code', 'redux-framework'), 
						'desc' => __('Paste your ShareThis or AddThis code here', 'redux-framework-demo'),
						'default' => ''
					),
                ),
            );
            ...
            $this->sections[] = array(
                'icon'       => 'el-icon-website',
                'title'      => __( 'Home services', 'redux-framework' ),
                'subsection' => true,
                'fields'     => array(
                    array(
                        'id'               => 'home_services',
                        'type'             => 'editor',
                        'title'    => __('Home services', 'redux-framework'),
                        'subtitle'         => __('HTML tags allowed: h2, a, img', 'redux-framework'),
                        'default'          => '',
                        'args'   => array(
                            'teeny'            => true,
                            'textarea_rows'    => 5,
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'        => 'blog_header_text',
                        'type'      => 'text',
                        'title'     => __('Blog header text', 'redux-framework'),
                        'default'   => 'Blog'
                    ),
					array(
                        'id'        => 'readmore_text',
