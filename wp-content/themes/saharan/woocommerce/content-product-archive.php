...
<div <?php post_class( $classes ); ?>>
	<div class="product-wrapper">
		...
		<?php if ( $product->is_on_sale() ) : ?>
			<?php echo apply_filters( 'woocommerce_sale_flash', '<span class="onsale"><span class="sale-text">' . esc_html__( 'Sale', 'saharan' ) . '</span></span>', $post, $product ); ?>
		<?php endif; ?>
			...
			<div class="product-image">
				...
				<div class="actions clearfix">
					<div class="action-buttons">
						<a class="detail-link quickview" data-quick-id="<?php the_ID();?>" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><i class="fa fa-eye"></i><?php esc_html_e('Quick View', 'saharan');?></a>
