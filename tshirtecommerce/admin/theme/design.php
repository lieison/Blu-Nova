	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<?php echo lang('product_view_name'); ?> <strong><?php echo $data['position']; ?></strong>
				</div>				
				<div class="col-md-4">
					<ul class="colors">
						<li>							
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="design-tools row col-md-12">
						...
						<a href="javascript:void(0)" title="" onclick="jQuery.fancybox( {href : '<?php echo site_url_ci('index.php/media/modals/design/2') ?>', type: 'iframe'} );"><i class="clip-upload"></i> <?php echo lang('product_change_design');?></a>
					</div>
					<br>
					<div class="row">
						<div class="col-md-12">
				...
				<div class="col-md-4" id="product-designer-options">
					<!-- area size -->
