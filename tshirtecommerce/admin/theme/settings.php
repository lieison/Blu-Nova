...
<script type="text/javascript" src="<?php echo site_url_ci('assets/plugins/chosen/chosen.jquery.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url_ci('assets/js/jquery.jeditable.js'); ?>"></script>
...
<div class="tab-content">
		...
		<div class="row">
			<div class="col-md-8">
				<div class="form-group row">
					<label class="col-sm-3 control-label"><?php lang('setting_shop_site_url'); ?></label>
					<div class="col-sm-6">
				...
				<div class="form-group row">
					<label class="col-sm-3 control-label"><?php lang('setting_shop_site_name'); ?></label>
					<div class="col-sm-6">
	...
	<div class="tab-pane" id="shop">
		...
		<div class="pull-right col-md-6">
			<h4><?php lang('settings_lang_menu'); ?></h4>
			<hr />
			<div class="form-group row">
...
<script type="text/javascript">
	...
	function getLanguage()
	{
		...
		jQuery.ajax({
			type: "POST",
			url: '<?php echo site_url_ci().'index.php/settings/getlang'?>',
	...
	function tranlateLang(e)
	{
		...
		jQuery.ajax({
			type: "POST",
			url: '<?php echo site_url_ci().'index.php/settings/editlang'?>',
	...
	function submit(){
		jQuery.ajax({
			type: "POST",
			url: "<?php echo site_url_ci();?>settings/configuaration",
