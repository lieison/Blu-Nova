					...
					<!-- start: PAGE CONTENT -->
						...
						<div class="row">
							<div class="col-md-5 pull-right text-right">
								<a href="<?php echo site_url_ci().'fonts.php'?>" class="btn btn-danger" ><?php lang('cancel'); ?></a>
							</div>
						</div>
						...
						<div id="ajax-modal" class="panel panel-default">
							...
							<div class="modal-body">
								...
								<div class="modal fade" id="modal_edit_cate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<form action="<?php echo site_url_ci()?>/editcate" method="post" id="fr-edit-cate">
								...
								<div style="display: none;">
									<form action="<?php echo site_url_ci();?>/delcate" method="post" id="fr-del-cate">
						...
						<script type="text/javascript">
							function addCate() {
								...
								html = html + '<form method="post" action="<?php echo site_url_ci('edit_fonts.php')?>" id="form-add" class="form-add">';
							...
							function update() {
								...
								jQuery.post("<?php echo site_url_ci('fonts/add_cate') ?>", function(data) {
							...
							function load() {
								...
								jQuery('#panel-form,.modal-body').block({
									...
									message: '<img src="<?php echo site_url_ci()?>assets/images/loading.gif" /> <?php lang('load_text'); ?>',
									css: {
										border: 'none',
										color: '#333',
										background: 'none'
