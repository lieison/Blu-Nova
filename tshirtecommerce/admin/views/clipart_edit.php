...
<div class="row">
	<div class="col-md-6 pull-right text-right">
		...
		<a href="<?php echo site_url_ci('index.php/clipart'); ?>" class="btn btn-danger"><?php lang('close');?></a>
	</div>
</div>
<hr />
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form enctype="multipart/form-data" id="add-clipart" class="form-horizontal" method="post" action="<?php echo site_url_ci('index.php/clipart/save'); ?>">
			<div class="col-sm-10">
