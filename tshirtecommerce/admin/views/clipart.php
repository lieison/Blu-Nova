 ...
 */
?>
<link rel="stylesheet" href="<?php echo site_url_ci('assets/plugins/dynatree/src/skin-vista/ui.dynatree.css'); ?>">
<link href="<?php echo site_url_ci('assets/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css'); ?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url_ci('assets/plugins/bootstrap-modal/css/bootstrap-modal.css'); ?>" rel="stylesheet" type="text/css"/>

<script src="<?php echo site_url_ci('assets/js/dg-function.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/plugins/dynatree/src/jquery.dynatree.js'); ?>"></script>
...
<script>
	...
	var url_assets = '<?php echo site_url_ci('assets/js/'); ?>';	
...
<div class="row">
	...
	<!-- start: LIST CLIPART -->
	<div class="col-md-9">	
		<form id="artform" action="<?php echo site_url_ci('index.php/clipart'); ?>" method="post" name="artform">
				...
				<div class="panel-body">				
					<div class="row">														
						...
						<div class="col-md-4 text-right pull-right">
							<a href="<?php echo site_url_ci('index.php/clipart/edit'); ?>" class="btn btn-primary" title="<?php lang('add'); ?>">
								<i class="glyphicon glyphicon-plus"></i>					
							</a>						
					...
					<div class="row" id="clipart-rows">
						...
						?>
							<div class="col-md-2 col-sm-3 box-art">
								...
								<a class="box-edit" href="<?php echo site_url_ci('index.php/clipart/edit/'.$art->clipart_id); ?>">
						...
						<div id="arts-pagination" class="pull-right col-md-12 text-right">
							...
							<ul class="pagination">
								...
								<?php for($i=1; $i<=$data['page']; $i++) { ?>
									...
									<?php }else{ ?>
										<li><a href="<?php echo site_url_ci('index.php/clipart/index/'.$i.'/'.$data['cateid']); ?>"><?php echo $i; ?></a></li>
									<?php } ?>
...
<script type="text/javascript">
	function submit_delete()
	{
		...
		if(cf)
		{
			jQuery('#artform').attr('action', '<?php echo site_url_ci('index.php/clipart/delete'); ?>');
