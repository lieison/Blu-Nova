...
<div class="col-md-12">
	<form class="fr-fonts" id="panel-form" action="<?php echo site_url_ci('index.php/settings/fonts'); ?>" method="POST">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="col-sm-2">
		...
		<div class="col-md-6">
			<p style="text-align:right;">
				...
				<a class="btn btn-primary tooltips" href="<?php echo site_url_ci('index.php/settings/editfont')?>" data-placement="top" data-original-title="<?php lang('fonts_add_new'); ?>">
								...
								<tr>
									...
									<td class="center">
										...
										<?php 
											...
											{
										?>
											<img src="<?php echo str_replace('admin/', '', site_url_ci()).'data/fonts/'.$val['thumb']; ?>" alt="">
										<?php } ?>
									</td>
									...
									<td class="center">
										<?php
											...
											{
										?>
												<a href="<?php echo site_url_ci().'index.php/settings/editfont/'.$val['id'];?>" class="btn btn-primary tooltips" data-original-title="<?php echo lang('edit');?>" data-placement="top">
...
<script type="text/javascript">
	...
	function pagination(segment)
	{
		jQuery.ajax({
			type: "POST",
			url: '<?php echo site_url_ci('index.php/settings/pagefont/'); ?>'+segment,
	...
	{	
		...
		{
			var url = '<?php echo site_url_ci('index.php/settings/publish'); ?>';
		}else if(type == 'unpublish' || type == 'unpublishall')
		{
			var url = '<?php echo site_url_ci('index.php/settings/unpublish'); ?>';
		}else
		{
			var url = '<?php echo site_url_ci('index.php/settings/removefont'); ?>';
