...
<script src="<?php echo site_url_ci('assets/plugins/validate/validate.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/plugins/chosen/chosen.jquery.min.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/plugins/tinymce/tinymce.min.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/plugins/bootstrap-modal/js/bootstrap-modal.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/js/ui-modals.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/js/jscolor.js'); ?>"></script>
<script src="<?php echo site_url_ci('assets/js/dg-function.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url_ci('assets/plugins/jquery-fancybox/jquery.fancybox.js'); ?>"></script>
<link rel="stylesheet" href="<?php echo site_url_ci('assets/plugins/jquery-fancybox/jquery.fancybox.css'); ?>">

<script type="text/javascript">
var site_url = '<?php echo site_url_ci(); ?>';
var base_url = '<?php echo site_url_ci(); ?>';
var url = '<?php echo site_url_ci(); ?>';
var areaZoom = 10;
...
tinymce.PluginManager.add('dgmedia', function(editor, url) {
	...
	editor.addButton('dgmedia', {
		...
		icon: false,
		onclick: function() {
			jQuery.fancybox( {href : site_url + 'index.php/media/modals/descriptMedia/2', type: 'iframe'} );
		}
	}); 
});
tinymce.init({
...
<div class="row">
	...
	<form id="fr-product" accept-charset="utf-8" method="post" action="<?php echo site_url_ci(). 'index.php/product/save'; ?>">
									...
									<div id="tabs-1">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<?php 
												$print_types = array(
													'screen'=>'settings_print_screen',
													'DTG'=>'settings_print_DTG',
													'sublimation'=>'settings_print_sublimation',
													'embroidery'=>'settings_print_embroidery',
												);
												...
												?>
													<option <?php echo $selected; ?> value="<?php echo $key; ?>"><?php echo lang($type); ?></option>
												<?php } ?>
					...
					<div class="col-sm-4 col-md-4">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<img width="100" alt="" class="pull-right" src="<?php echo setValue($product, 'image', ''); ?>">
								<a href="javascript:void(0)" class="btn btn-default btn-sm" onclick="jQuery.fancybox( {href : '<?php echo site_url_ci('index.php/media/modals/productImg/1') ?>', type: 'iframe'} );"><?php lang('product_add_image'); ?></a>
							</div>
						</div>
					</div>
					<!-- End righ -->
								...
								<table class="table table-bordered table-hover" id="product-design">
									<thead>
										<tr>
											...
											<th colspan="4" class="center" width="60%"><?php lang('view'); ?></th>											
									...
									?>
										...
										<tr id="color_<?php echo $i; ?>">
											<td class="center">
												...
												<a style="background-color:#<?php  echo $design->color_hex[$i]; ?>" onclick="dgUI.product.color.edit('<?php echo $i; ?>.0')" href="javascript:void(0)" class="color"></a>
											</td>
											...
											<td class="center">
												...
												<img width="50" id="front-products-img-<?php echo $i; ?>" src="<?php echo getImgage($front); ?>" alt=""> <br>
												<a onclick="dgUI.product.design(this, 'front')" href="javascript:void(0)"><?php lang('configure');?></a>
											</td>
											
											<td class="center">
												<input type="hidden" id="back-products-design-<?php echo $i; ?>" value="<?php  echo $back; ?>" name="product[design][back][]">
												<img width="50" id="back-products-img-<?php echo $i; ?>" src="<?php echo getImgage($back); ?>" alt=""> <br>
												<a onclick="dgUI.product.design(this, 'back')" href="javascript:void(0)"><?php lang('configure');?></a>
											</td>
											
											<td class="center">
												<input type="hidden" id="left-products-design-<?php echo $i; ?>" value="<?php  echo $left; ?>" name="product[design][left][]">
												<img width="50" id="left-products-img-<?php echo $i; ?>" src="<?php echo getImgage($left); ?>" alt=""> <br>
												<a onclick="dgUI.product.design(this, 'left')" href="javascript:void(0)"><?php lang('configure');?></a>
											</td>
											
											<td class="center">
												<input type="hidden" id="right-products-design-<?php echo $i; ?>" value="<?php echo $right; ?>" name="product[design][right][]">
												<img width="50" id="right-products-img-<?php echo $i; ?>" src="<?php echo getImgage($right); ?>" alt=""> <br>
												<a onclick="dgUI.product.design(this, 'right')" href="javascript:void(0)"><?php lang('configure');?></a>
											</td>
											
											<td class="center"><a onclick="dgUI.product.removeColor(this)" href="javascript:void(0)"><?php lang('remove'); ?></a></td>
										</tr>
...
<script type="text/javascript">
	...
	jQuery(function() {
		jQuery('#add-new-color').on('click', function(){
			UIModals.init('<?php echo site_url_ci('index.php/product/colors'); ?>');
