...
<div class="col-md-12">
<form class="form-languages" id="panel-form" method="POST" action="<?php echo site_url_ci('index.php/settings/languages'); ?>" onsubmit="return false;">
	<div class="row">
		<div class="col-md-12">
			<p style="text-align:right;">
				<a class="btn btn-primary tooltips" title="<?php echo lang('add'); ?>" href="javascript:;" onclick="UIModals.init('<?php echo site_url_ci('index.php/settings/editlanguage'); ?>')">
					...
					<tbody>
						<?php if(isset($data['languages'])) foreach ($data['languages'] as $key=>$language) { ?>
							<tr>
								...
								<td class="center">
									<a href="javascript:;" class="btn btn-teal tooltips" data-original-title="<?php echo lang('edit');?>" onclick="UIModals.init('<?php echo site_url_ci('index.php/settings/editlanguage/'.$key);?>')">
...
<script type="text/javascript">
	function editlanguage(type, id)
	{
		...
		if(check)
		{
			if(type == 'edit')
				...
				var url = '<?php echo site_url_ci('index.php/settings/languagedefault');?>/'+id;
			...
			jQuery.ajax({
				...
				beforeSend: function(){
					jQuery('#panel-form,.modal-body').block({
						...
						message: '<img src="<?php echo site_url_ci().'assets/images/loading.gif'?>" /> <?php echo lang('loading') ?>',
						css: {
							border: 'none',
							language: '#333',
							background: 'none'
	...
	{	
		...
		{
			var url = '<?php echo site_url_ci('index.php/settings/removelanguage'); ?>';
