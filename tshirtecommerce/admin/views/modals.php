 ...
 */
?>
<link href="<?php echo site_url_ci('assets/plugins/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
<link href="<?php echo site_url_ci('assets/fonts/style.css'); ?>" rel="stylesheet">
<link href="<?php echo site_url_ci('assets/css/files.css'); ?>" rel="stylesheet">
<link href="<?php echo site_url_ci('assets/css/jquery.contextMenu.css'); ?>" rel="stylesheet">
<script type="text/javascript" src="<?php echo site_url_ci('assets/js/jquery.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url_ci('assets/js/files.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url_ci('assets/js/jquery.contextMenu.js'); ?>"></script>
			...
			<div id="dag-files-right" class="menu-1">
				...
				<?php if($data['folders']) { ?>
					...
					<span class="view-thumb view-folder" data-path="<?php echo DS . $data['root'] .DS. $folder; ?>">
						<img src="<?php echo site_url_ci('assets/images/folder-icon-67X67.png'); ?>" alt="<?php echo $folder; ?>" />
				...
				<?php if(isset($data['files'])) { ?>
					...
					<span onclick="dagFiles.file.select(this)" class="view-thumb" title="<?php echo $file['name']; ?>" data-filename="<?php echo $file['filename']; ?>">
						...
						<span class="file-tool">
							<a rel="fancybox-thumb" class="fancybox-thumb" title="<?php lang('preview')?>" href="<?php echo site_url_ci($data['root'] .'/'. $file['name']); ?>"><i class="glyphicon glyphicon-eye-open"></i></a>
...
<script type="text/javascript" src="<?php echo site_url_ci('assets/js/upload.js'); ?>"></script>
<script type="text/javascript">
var selected = <?php echo (int) $data['selected']; ?>;
var base = '<?php echo site_url_ci(); ?>';
