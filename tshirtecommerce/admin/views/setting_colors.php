...
<div class="col-md-12">
<form class="form-color" id="panel-form" method="POST" action="<?php echo site_url_ci('index.php/settings/colors'); ?>" onsubmit="return false;">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="col-sm-2">
					...
					<tbody>
						<?php if(isset($data['colors'])) foreach ($data['colors'] as $key=>$color) { ?>
							<tr>
								...
								<td class="center">
									<a href="javascript:;" class="btn btn-teal tooltips" data-original-title="<?php echo lang('edit');?>" onclick="UIModals.init('<?php echo site_url_ci('index.php/settings/editcolor/'.$key);?>')">
...
<script type="text/javascript">
	...
	function pagination(segment)
	{
		jQuery.ajax({
			type: "POST",
			url: '<?php echo site_url_ci('index.php/settings/pagecolor/'); ?>'+segment,
	...
	{	
		...
		{
			var url = '<?php echo site_url_ci('index.php/settings/removecolor'); ?>';
