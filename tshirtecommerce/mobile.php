...
<head>
	...
	<meta content="<?php echo setValue($settings, 'site_name', 'T-Shirt eCommerce'); ?>" name="description" />
	...
	<link type="text/css" href="assets/css/style-mobile.css" rel="stylesheet" media="all">
	...
	<script src="<?php echo 'assets/js/design.js'; ?>"></script>	
	...
	<script type="text/javascript">
		...
		var siteURL = '<?php echo $settings->site_url; ?>tshirtecommerce/';
		var urlCase = '<?php echo $settings->site_url; ?>tshirtecommerce/image-tool/thumbs.php';
