		...
		if (isset($product))
		{
			...
			if (count($design))
			{
				...
				if (isset($area->$position) && $area->$position != '')
				{
					...
					$svg 		= '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="500" height="500">';					
					$svgPNG 		= '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="500" height="500">';					
