...
var design={
	...
	ajax:{
		...
		mydesign: function(){
			jQuery(document).triggerHandler( "before.save.design");
			...
			else
			{
				...
				jQuery.ajax({
					...
					jQuery('#dg-mydesign .design-box a').each(function(){
						...
						href = siteURL + 'admin-template.php?token='+token+'&user='+params[0]+'&id='+params[1]+'&product='+params[2]+'&color='+params[3]+'&parent=0';
				...
				if (typeof obj[i] != 'undefined')
				{
					...
					try {							
						...
						else
						{
							...
							{
								textPathcanvas(item, context, canvasLoad, obj, i);
							}
						}
