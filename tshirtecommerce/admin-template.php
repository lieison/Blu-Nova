...
if ( isset($config) && isset($_GET['token']) )
{
	...
	if ($code == $token)
	{
		...
		$id 	= md5($config['email'].$config['password']);
...
<head>
	...
	<script src="<?php echo 'assets/js/design-admin.js'; ?>" type="text/javascript" charset="utf-8"></script>	
