        ...
        <div class="align-center" id="right-options">
            <div class="dg-box">
                <div class="accordion">
                    ...
                    <!-- OCULTAR color used & Screen size -->
                    <h3 style="display:none;" <?php echo cssShow($settings, 'show_color_used'); ?>><?php echo lang('designer_right_color_used'); ?></h3>
                    <div class="color-used" <?php echo cssShow($settings, 'show_color_used'); ?>></div>

                    <h3 style="display:none;" <?php echo cssShow($settings, 'show_screen_size'); ?>><?php echo lang('designer_right_screen_size'); ?></h3>
                ...
                <div class="product-prices">
                    <div id="product-price" <?php echo cssShow($settings, 'show_price', 1); ?>>
                        ...
                        <!-- OCULTA el icono de actualizar -->
                        <span style="display:none;" class="price-restart" title="<?php echo lang('designer_get_price'); ?>" onclick="design.ajax.getPrice()"><i class="glyphicons restart"></i></span>
                        <!-- -->
